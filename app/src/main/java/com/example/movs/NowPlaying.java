...
public class NowPlaying implements Parcelable {
    ...
    public NowPlaying(String title, String original_title, Double vote_average, String backdrop_path, Integer id, Double popularity, boolean video, String poster_path, boolean adult, String overview, String release_date, String original_language, List<Integer> genreIds, Integer voteCount) {
        this.title = title;
