...
public class TrailersInfo implements Parcelable {
    ...
    public TrailersInfo(String id, String iso_639_1, String iso_3166_1, String key, String name, String site, int size, String type) {
        this.id = id;
    ...
    protected TrailersInfo(Parcel in) {
        id = in.readString();
